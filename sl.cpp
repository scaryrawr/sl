...
int add_sl(int x)
{
    static const wchar_t *sl[LOGOPATTERNS][LOGOHEIGHT + 1] = {{LOGO1, LOGO2, LOGO3, LOGO4, LWHL11, LWHL12, DELLN},
    ...
    static const wchar_t *coal[LOGOHEIGHT + 1] = {LCOAL1, LCOAL2, LCOAL3, LCOAL4, LCOAL5, LCOAL6, DELLN};

    static const wchar_t *car[LOGOHEIGHT + 1] = {LCAR1, LCAR2, LCAR3, LCAR4, LCAR5, LCAR6, DELLN};
...
int add_D51(int x)
{
    static const wchar_t *d51[D51PATTERNS][D51HEIGHT + 1] = {{D51STR1, D51STR2, D51STR3, D51STR4, D51STR5, D51STR6, D51STR7,
    ...
    static const wchar_t *coal[D51HEIGHT + 1] = {COAL01, COAL02, COAL03, COAL04, COAL05,
                                                 COAL06, COAL07, COAL08, COAL09, COAL10, COALDEL};

    static const wchar_t *car[D51HEIGHT + 1] = {CAR01, CAR02, CAR03, CAR04, CAR05,
...
int add_C51(int x)
{
    static const wchar_t *c51[C51PATTERNS][C51HEIGHT + 1] = {{C51STR1, C51STR2, C51STR3, C51STR4, C51STR5, C51STR6, C51STR7,
    ...
    static const wchar_t *coal[C51HEIGHT + 1] = {COALDEL, COAL01, COAL02, COAL03, COAL04, COAL05,
                                                 COAL06, COAL07, COAL08, COAL09, COAL10, COALDEL};

    static const wchar_t *car[C51HEIGHT + 1] = {COALDEL, CAR01, CAR02, CAR03, CAR04, CAR05,
                                                CAR06, CAR07, CAR08, CAR09, CAR10, COALDEL};
...
void add_man(int y, int x)
{
    static const wchar_t *man[2][2] = {{L"", L"(O)"}, {L"Help!", L"\\O/"}};
    int i;
...
#define SMOKEPTNS 16
{
    ...
    static int sum = 0;
    static const wchar_t *Smoke[2][SMOKEPTNS] = {{L"(   )", L"(    )", L"(    )", L"(   )", L"(  )",
                                                  L"(  )", L"( )", L"( )", L"()", L"()",
                                                  L"O", L"O", L"O", L"O", L"O",
                                                  L" "},
                                                 {L"(@@@)", L"(@@@@)", L"(@@@@)", L"(@@@)", L"(@@)",
                                                  ...
                                                  L"@", L"@", L"@", L"@", L"@",
                                                  L" "}};
    static const wchar_t *Eraser[SMOKEPTNS] = {L"     ", L"      ", L"      ", L"     ", L"    ",
                                               L"    ", L"   ", L"   ", L"  ", L"  ",
                                               L" ", L" ", L" ", L" ", L" ",
                                               L" "};
